...
public class StudentController {
    ...
    public String addStudentComment(@RequestBody StudentComment studentComment) {
     ...
     @GetMapping("/allComment/{studentId}")
    public List<String> allComment (@PathVariable String studentId){
        return studentService.allComment(studentId);
     }
    @GetMapping("/getDetail/{Id}")
    public StudentCommentDetail getStudentCommentDetail(@PathVariable String Id){
        return studentService.getStudentCommentDetail(Id);
    }
}
